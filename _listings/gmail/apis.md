...
- name: Gmail Send Verification Email
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/verification/master/_listings/gmail/userid-settings-sendas-sendasemail-verify-post-postman.md
x-common:
- type: x-auth-scopes
